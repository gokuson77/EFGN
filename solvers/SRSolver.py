...
class SRSolver(BaseSolver):
    def __init__(self, opt):
        ...
        if self.is_train:
            ...
            elif optim_type == "LOOKAHEAD_RADAM":
                from .ranger import Ranger
                self.optimizer = Ranger(self.model.parameters(), lr=self.train_opt['learning_rate'], weight_decay=weight_decay)
    ...
    def load(self):
        ...
        if (self.is_train and self.opt['solver']['pretrain']) or not self.is_train:
            ...
            if self.is_train:
                ...
                #     else:
                #         new_state_dict[k] = v
                # self.model.load_state_dict(new_state_dict['state_dict'])
